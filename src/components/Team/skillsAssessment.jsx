...
import teamsDate from "../../data/assessment/skills.json";
          ...
          <div className="col-lg-5 valign">
            <div className="content wow fadeInUp md-mb30" data-wow-delay=".5s">
              <div className="sub-title">
                <h6>Skills Showcase</h6>
                <span></span>
                <span></span>
                <span></span>
              </div>
              <h3 className="co-tit mb-15">
                Choose your skill and find your Skill IQ.
              </h3>
              <p>
                We have multiple skills to choose from. Assess your skills and find out how you compare with other Coders(hq) members.
              </p>
